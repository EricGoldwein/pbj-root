...
- **No resident-level acuity in PBJ.** Census comes from MDS, but PBJ does not tie hours to individual residents or case mix. Compare with Provider Info case-mix or other acuity measures when interpreting adequacy.

- **Policy lines are not verdicts.** MACPAC-style state minimums on PBJ320 (see [State Staffing Standards](/pbjpedia/state-standards)) are policy summaries—not proof a facility violated state law.

- **Quarterly exclusions, daily outliers.** A facility can remain in the PUF while showing unusual single-day hours.

- **Underreported physician hours.** Medical director and attending physician time is often billed outside facility payroll.
...
2. CMS. **[PBJ Policy Manual v2.4](https://www.cms.gov/medicare/quality-initiatives-patient-assessment-instruments/nursinghomequalityinits/downloads/pbj-policy-manual-final-v24.pdf)**.
