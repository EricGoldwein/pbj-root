...
- Add explicit routes for critical assets: `/LI-In-Bug.png`, `/substack.png`, `/press/wtvr-twin-lakes-clip.mp4`, `/press/wtvr-thumbnail.jpg`### Rule: Route OrderMore specific routes first; parameter routes must check for static file extensions before processing; catch-all last.
