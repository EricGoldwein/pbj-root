...
def normalize_fec_donation(record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Image number for docquery link - OpenFEC returns sub_id or image_num (snake_case)
    image_number = record.get("sub_id") or record.get("image_num") or record.get("image_number") or ""
    docquery_url = _build_docquery_url(committee_id, image_number)
    ...
    return {
        ...
        "fec_record_id": str(image_number) if image_number else "",
        "fec_docquery_url": (docquery_url or ""),
