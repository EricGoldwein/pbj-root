...
try:
    ...
    print(f"   1. index-render.html: chart titles should use runtime endYear (not a fixed '{dates['data_range']}')")
    ...
    print(f"   5. about.html: methodology uses __PBJ_DATA_RANGE_NDASH__ (served as '{dates['data_range']}')")
    ...
    print(f"   Fallback dates: 2017-{datetime.now().year}, 33 quarters")
