...
(function () {
  ...
  function injectFooter(el) {
    if (!el) return;
    el.innerHTML = [
      '<p style="margin:0 0 1rem 0;color:rgba(255,255,255,0.55);font-size:0.8rem;text-align:center;letter-spacing:0.03em"><strong>320 Consulting</strong> — Turning Spreadsheets into Stories</p>',
