  ...
  return (
    ...
    >
      <div className="relative z-10 w-full flex flex-col justify-center items-center" style={{ minHeight: '100%', height: '100%', paddingBottom: '8px' }}>
        {!hideBadge && (
          <div className="text-center mb-2 flex-shrink-0 relative z-20">
            <a
        ...
        <div className="flex-1 flex flex-col justify-center items-center w-full">
          ...
          {noContainer ? (
            ...
            <div className="text-center text-base md:text-lg bg-black/70 backdrop-blur-md rounded-3xl p-4 md:p-5 lg:p-6 pb-4 md:pb-6 lg:pb-7 shadow-2xl border-2 border-blue-500/50 flex-shrink-0 w-full max-w-full overflow-y-auto max-h-[75vh] md:max-h-[80vh] scrollbar-thin scrollbar-thumb-blue-500/50 scrollbar-track-transparent transition-all duration-300 hover:border-blue-400/60 hover:shadow-blue-500/20">
              {children}
            </div>
          )}
        </div>
