        ...
        {hasStaffingData && (
          <>
            <div className="pt-4 border-t border-gray-600">
              <p className="text-gray-300 text-xs md:text-sm text-center mb-3">
                Median Total Staff HPRD by Ownership Type (Q2 2025)
              </p>
              <div className="space-y-2">
                {data.ownership.forProfit.medianHPRD !== undefined && (
                  <div className="flex justify-between items-center py-1.5 border-b border-gray-600">
                    ...
                    <span className="text-white font-bold text-lg">
                      {formatHPRD(data.ownership.forProfit.medianHPRD)}
                    </span>
                  </div>
                )}
                ...
                {data.ownership.nonProfit.medianHPRD !== undefined && (
                  <div className="flex justify-between items-center py-1.5 border-b border-gray-600">
                    ...
                    <span className="text-white font-bold text-lg">
                      {formatHPRD(data.ownership.nonProfit.medianHPRD)}
                    </span>
                  </div>
                )}
                ...
                {data.ownership.government.medianHPRD !== undefined && (
                  <div className="flex justify-between items-center py-1.5">
                    ...
                    <span className="text-white font-bold text-lg">
                      {formatHPRD(data.ownership.government.medianHPRD)}
                    </span>
                  </div>
                )}
              </div>
