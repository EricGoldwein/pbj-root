      ...
      <div className="space-y-3 text-left">
        <div className="bg-orange-500/10 border-l-4 border-orange-400 pl-3 md:pl-4 py-2 rounded">
          <p className="text-gray-200 text-xs md:text-sm leading-relaxed">
            <strong className="text-orange-300">Special Focus Facilities (SFFs)</strong> are nursing homes with a history of serious quality problems. They receive enhanced oversight from CMS.
          </p>
        </div>
