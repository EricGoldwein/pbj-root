...
def _render_pbjai_info_btn() -> str:
    return (
        ...
        '<span class="pbj-ai-pbjai-hint" aria-hidden="true">ⓘ</span>'
        '</button>'
    )
...
def render_pbj_ai_beta_modal(helper_uid: str = 'default') -> str:
    ...
    return (
        ...
        f'<span class="pbj-ai-beta-tag">beta</span></h3>'
        ...
        '<li>Builds a <strong>shows / suggests / cannot prove</strong> review for Ombudsman, Family, or Journalist.</li>'
        '<li>Uses this page&apos;s staffing metrics and trends from PBJ320.</li>'
